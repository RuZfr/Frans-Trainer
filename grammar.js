(() => {
  ...
  async function loadData(){
    if(data)return data;
    try{
      const url=new URL(`./data/grammar/cod.json?v=1.18.3`,document.baseURI);
  ...
  function renderQuestion(){
    ...
    if(item.type==="recognition"){
      questionType.textContent=item.question||"Wat is het COD?";
